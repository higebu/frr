...
enum srv6_endpoint_behavior_codepoint {
	...
	SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_D     = 0x0045,
	SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_D_DI  = 0x0046,
	SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_E     = 0x0047,
	SRV6_ENDPOINT_BEHAVIOR_END_M_GTP4_E     = 0x0048,
	SRV6_ENDPOINT_BEHAVIOR_H_M_GTP4_D       = 0x0049,
...
srv6_endpoint_behavior_codepoint2str(enum srv6_endpoint_behavior_codepoint behavior)
{
	...
	case SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_D:
		return "End.M.GTP6.D";
	case SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_D_DI:
		return "End.M.GTP6.D.Di";
	case SRV6_ENDPOINT_BEHAVIOR_END_M_GTP6_E:
		return "End.M.GTP6.E";
	case SRV6_ENDPOINT_BEHAVIOR_END_M_GTP4_E:
		return "End.M.GTP4.E";
	case SRV6_ENDPOINT_BEHAVIOR_H_M_GTP4_D:
		return "H.M.GTP4.D";
