...
def test_dsd_policy_owns_only_its_dt_sid():
    ...
    r1 = tgen.gears["r1"]
    # Both SIDs are armed by the time r2 sees the ISD/DSD (checked
    # above); give a stray allocation a moment to land as well.
    time.sleep(3)
    sids = _bgp_sids_under(r1, "2001:db8:e::/48")
    assert len(sids) == 2, (
