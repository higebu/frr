...
/* import / export sides of the unicast<->BGP-MUP leak.  EXPLICIT
 * latches once the operator types `[no] <import|export> mup` so
 * subsequent rd|rt|sid mup edits don't re-trigger auto-set.
 */
#define BGP_CONFIG_MUP_TO_VRF_IMPORT (1 << 12)
#define BGP_CONFIG_MUP_TO_VRF_IMPORT_EXPLICIT (1 << 13)
#define BGP_CONFIG_VRF_TO_MUP_EXPORT (1 << 14)
#define BGP_CONFIG_VRF_TO_MUP_EXPORT_EXPLICIT (1 << 15)
