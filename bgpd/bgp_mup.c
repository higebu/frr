...
void bgp_mup_vty_init(void)
{
	...
	install_element(BGP_IPV4_MUP_NODE, &af_no_rt_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_rt_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_no_rt_mup_cmd);

	install_element(BGP_IPV4_MUP_NODE, &af_rd_mup_cmd);
	install_element(BGP_IPV4_MUP_NODE, &af_no_rd_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_rd_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_no_rd_mup_cmd);

	install_element(BGP_IPV4_MUP_NODE, &af_sid_mup_cmd);
	install_element(BGP_IPV4_MUP_NODE, &af_no_sid_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_sid_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_no_sid_mup_cmd);

	install_element(BGP_IPV4_MUP_NODE, &af_nexthop_mup_cmd);
	install_element(BGP_IPV4_MUP_NODE, &af_no_nexthop_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_nexthop_mup_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_no_nexthop_mup_cmd);

	install_element(BGP_IPV4_MUP_NODE, &af_mup_route_map_cmd);
	install_element(BGP_IPV4_MUP_NODE, &af_no_mup_route_map_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_mup_route_map_cmd);
	install_element(BGP_IPV6_MUP_NODE, &af_no_mup_route_map_cmd);
