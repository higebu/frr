...
/* TODO - Other memory may need to be freed - e.g., NHT */
	...
	/* Drop BGP-MUP per-bgp state here, not from bgp_free(): at shutdown
	 * the default vrf's lock can stay above one and bgp_free() never
	 * runs, leaking any lazy-allocated mup_state.
	 */
